...
static int hornpipe_MAXIMUM_COUNT = sizeof(hornpipe_tune) / 2; // Tune length i.o.t. loop
...
static int colmans_MAXIMUM_COUNT = sizeof(colmans_tune) / 2;

static int StartingBuzzer_tune[] = {Col_c5, Col_b4m, Col_a4m, Col_e4, Col_c4};
static int StartingBuzzer_beats[] = {20, 20, 20, 20, 20};
static int StartingBuzzer_MAXIMUM_COUNT = sizeof(StartingBuzzer_tune) / 2; 
// tempo
